...
#-- output and conf
PROJDIR=`pwd`/../project
PAR_FILE=${PROJDIR}/test1.json
GRID_DIR=${PROJDIR}/output1
MEDIA_DIR=${PROJDIR}/output1
SOURCE_DIR=${PROJDIR}/output1
OUTPUT_DIR=${PROJDIR}/output1
...
cat << ieof > $PAR_FILE
{
  ...
  "medium" : {
      ...
      "code" : "func_name_here",
      "#import" : "$MEDIA_DIR",
      "#infile_layer" : "$INPUTDIR/prep_medium/tangshan_basin.md3lay",
  ...
  "in_source_file" : "$INPUTDIR/prep_source/test_source1.src",
  "is_export_source" : 1,
