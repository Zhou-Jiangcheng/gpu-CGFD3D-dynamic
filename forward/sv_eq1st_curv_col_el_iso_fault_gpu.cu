                         ...
                         const int myid, const int verbose)
{
  ...
  float *f_hVx  = f_rhs_d + f_wav_d.Vx_pos;
  float *f_hVy  = f_rhs_d + f_wav_d.Vy_pos;
  float *f_hVz  = f_rhs_d + f_wav_d.Vz_pos;
  ...
  float *f_T11 = f_wav_d.T11;
  float *f_T12 = f_wav_d.T12;
  float *f_T13 = f_wav_d.T13;
  ...
  int jdir = fdy_op->dir;
  int kdir = fdz_op->dir;
  int isfree = bdryfree_d.is_at_sides[2][1];
  {
...
__global__
void sv_eq1st_curv_col_el_iso_rhs_fault_stress_gpu(
                       ...
                       fault_t f_d, bdryfree_t bdryfree_d, int isfree, int i0,
                       int nj1, int nj, int nk1, int nk, int ny, 
                       size_t siz_line, size_t siz_slice, size_t siz_slice_yz,
                       int idir, int jdir, int kdir)
{
